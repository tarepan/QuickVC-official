"""
Cloned from https://github.com/OlaWod/FreeVC/tree/main @2023-06-28, under MIT licence
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--in_dir", type=str, default="./corpus/vctk/wav48_silence_trimmed/", help="path to source dir")
    parser.add_argument("--out_dir1", type=str, default="./dataset/vctk-16k/vctk-16k", help="path to target dir")
